...
describe('Alerts: Creating Fixed Limit models', function () {
    ...
    it('Creating Fixed Limit Model', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_6) {
            switch (_6.label) {
                ...
                case 16: 
                // tslint:disable-next-line:max-line-length
                return [4 /*yield*/, _p.apply(_o, [(_6.sent()).indexOf('Mill C')])
                        .$('[class="arrow-cursor fa fa-caret-right"]').click()];
                case 17:
                    // tslint:disable-next-line:max-line-length
                    _6.sent();
                ...
                case 19:
                    ...
                    modelName = modelName + '_Fixed Limit model';
                    // * Creating models
                ...
                case 20:
                    ...
                    appTitle.selectDropdownbyNum(protractor_1.$('[ng-model="vm.selectedModelType"]'), 2);
                    ...
                    // tslint:disable-next-line:max-line-length
                    protractor_1.$('[ng-click="$ctrl.localChange(\'ActiveConfiguration\', \'Anomalies\'); $ctrl.localChange(\'ShowHide Range Selector\', false)"]').click();
                    return [4 /*yield*/, protractor_1.$('[ng-model="$ctrl.anomaliesConfig.ActivateFixedUpper"]').click()];
                case 21:
                    _6.sent();
                    protractor_1.$('[ng-model="$ctrl.anomaliesConfig.FixedLimitUpper"]').click();
                    protractor_1.$('[ng-model="$ctrl.anomaliesConfig.FixedLimitUpper"]').sendKeys('50000');
                    return [4 /*yield*/, protractor_1.$('[ng-model="$ctrl.anomaliesConfig.ActivateFixedLower"]').click()];
                case 22:
                    _6.sent();
                    protractor_1.$('[ng-model="$ctrl.anomaliesConfig.FixedLimitLower"]').click();
                    protractor_1.$('[ng-model="$ctrl.anomaliesConfig.FixedLimitLower"]').sendKeys('30000');
                ...
                case 27:
                    ...
                    return [4 /*yield*/, appTitle.dataExplorerNavElemSelector.assetNodeTree
                            .getText()];
                case 28: return [4 /*yield*/, _r.apply(_q, [(_6.sent()).indexOf('nD Test Client')])
                        .$('[class="arrow-cursor fa fa-caret-right"]').click()];
                case 29:
                    _6.sent();
                ...
                case 40: 
                // tslint:disable-next-line:max-line-length
                return [4 /*yield*/, _3.apply(_2, [(_6.sent()).indexOf('Mill C')])
                        .click()];
                case 41:
                    // tslint:disable-next-line:max-line-length
                    _6.sent();
                ...
                case 42:
                    modelIndex = (_6.sent()).indexOf(modelName);
                ...
                case 43:
                    ...
                    return [4 /*yield*/, protractor_1.$$('[class="text-right lightTableCell ng-binding"]')
                            .getText()];
                case 44: return [4 /*yield*/, _5.apply(_4, [(_6.sent()).indexOf(modelName) + 7]).getText()];
                case 45:
                    divs2 = _6.sent();
                    console.log(divs);
                    console.log(divs2);
    ...
    it('Deleting Fixed Limit model', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
...
//# sourceMappingURL=spec03_Creating_Fixed_Limit_Model.js.map