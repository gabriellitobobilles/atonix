...
describe('Alert: Right click on model perform all actions', function () {
    ...
    it('Show Related Models', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var _a;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 3:
                    ...
                    return [4 /*yield*/, protractor_1.browser.getTitle()];
                case 4:
                    _a.apply(void 0, [(_b.sent()) === "Alerts"]).toBe(true, "Title is not Alerts Screening View");
    ...
    it('Show Related Issues', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    alerthelper.alertScreeningView.modelsVM.first().click();
