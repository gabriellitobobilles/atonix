        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, page.saveQsrchTitleTbox.sendKeys('SaveContinue', +uniqueVal)];
                case 3:
                    _a.sent();
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    protractor_1.browser.sleep(3650);
                    protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.css('#grid-chart > svg > g:nth-child(1) > rect:nth-child(43)'))).perform();
                    protractor_1.browser.actions().
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('Step 13');
                    EC = protractor_1.protractor.ExpectedConditions;
                    protractor_1.browser.sleep(3550);
                    return [4 /*yield*/, protractor_1.browser.actions().mouseMove(page.RMtab).click().perform()];
                case 1:
                    _a.sent();
                    ...
                    expect(page.scoreCardNum.isPresent()).toBe(false, 'Default Scorecard is longer seen');
                    protractor_1.browser.sleep(3650);
                    protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.css('#grid-chart > svg > g:nth-child(1) > rect:nth-child(86)'))).perform();
                    protractor_1.browser.actions().
...
//# sourceMappingURL=spec04_RAmatrixList1.e2e-spec.js.map