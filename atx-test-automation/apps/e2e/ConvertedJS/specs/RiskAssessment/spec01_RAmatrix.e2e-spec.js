    ...
    it('should count the green, yellow and red risk matrix blocks', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    if (!(riskcount == 25)) return [3 /*break*/, 11];
                    console.log(riskcount, " blocks 5x5");
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, protractor_1.browser.wait(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, protractor_1.browser.element(protractor_1.by.css('#ra-spinner.ng-hide')).isPresent];
    ...
    it('should click the zoom-out button and view returned to default risk matrix blocks', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    protractor_1.browser.wait(EC.invisibilityOf(page.RMzoomInApld), 250000);
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    protractor_1.browser.sleep(3000);
                    protractor_1.browser.wait(EC.presenceOf(page.RMzoomInApld), 20000);
                    expect(page.RMzoomInApld.isPresent()).toBe(true, 'Zoom-in text applied is seen');
                    return [2 /*return*/];
            }
        });
    ...
    it('should click the RA gear button and see the Risk Matrix User Setting dialog menu', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    protractor_1.browser.wait(EC.presenceOf(page.RAuserSettingDlg), 110000);
    ...
    it('should click the + button on the Risk Matrix User Setting dialog menu, and see New Config*', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    protractor_1.browser.wait(EC.presenceOf(page.RANewConfigName), 110000);
    ...
    it('should click the close dialog button on the Risk Matrix User Setting dialog menu', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    protractor_1.browser.wait(EC.invisibilityOf(page.RAuserSettingDlg), 190000);
                    return [2 /*return*/];
            }
        });
    }); });
    it('should click single view radio button on the Risk Matrix tab and should see a toast error', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    protractor_1.browser.wait(EC.presenceOf(page.RAsChartTerror), 110000);
    ...
    it('should click single view radio button on the Risk Matrix tab and should see a white bubble', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    protractor_1.browser.wait(EC.presenceOf(page.RAsvWhitebuble), 110000);
                    protractor_1.browser.sleep(4000);
    ...
    it('should click multiple view radio button on the Risk Matrix tab and should see a toast error', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    protractor_1.browser.wait(EC.invisibilityOf(page.RAsvWhitebuble), 110000);
                    protractor_1.browser.sleep(4000);
    ...
    it('should count the green, yellow and red risk matrix blocks', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    riskcount = _a.sent();
                    if (!(riskcount == 25)) return [3 /*break*/, 7];
                    console.log(riskcount, " blocks 5x5");
                    console.log('this is not a 10x10 risk matrix');
                    i = 24;
                    _a.label = 3;
                ...
                case 7:
                    if (!(riskcount == 100)) return [3 /*break*/, 12];
                    console.log(riskcount, " blocks 10x10");
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    iMisplaced = 0;
                    protractor_1.browser.sleep(3000);
                    protractor_1.browser.wait(EC.invisibilityOf(protractor_1.element(protractor_1.by.className('mapLoadingSpinner'))), 128000);
                    return [4 /*yield*/, protractor_1.$('[id="grid-chart"]').element(protractor_1.by.tagName('svg')).element(protractor_1.by.tagName('g')).$$('rect').count()];
                case 1:
                    riskcount = _a.sent();
                    if (!(riskcount == 25)) return [3 /*break*/, 6];
                    console.log("5x5 blocks: ", riskcount);
                    i = 24;
                    _a.label = 2;
                case 2:
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    protractor_1.browser.sleep(3000);
                    protractor_1.browser.actions().
                        mouseDown(protractor_1.element(protractor_1.by.css('#grid-chart > svg > g:nth-child(1) > rect:nth-child(16)'))).
                        mouseMove(protractor_1.element(protractor_1.by.css('#grid-chart > svg > g:nth-child(1) > rect:nth-child(8)'))).
                        mouseUp().
                        perform();
                    return [4 /*yield*/, protractor_1.browser.actions().mouseMove(page.mtrxZoomIn).click().perform()];
                case 1:
    ...
    it('should click the clear button and view returned to default risk matrix blocks', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    protractor_1.browser.wait(EC.invisibilityOf(page.RMzoomInApld), 190000);
                    expect(page.RMzoomInApld.isPresent()).toBe(false, 'Zoom-in text applied is no longer seen');
                    return [2 /*return*/];
            }
        });
...
//# sourceMappingURL=spec01_RAmatrix.e2e-spec.js.map