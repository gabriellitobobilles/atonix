    ...
    it('should click on nD Test Client and expand its assets', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 1:
                    _b.apply(_a, [(_g.sent()).indexOf('nD Test Client')])
                        .$('[class="arrow-cursor fa fa-caret-right"]').click();
                    protractor_1.browser.sleep(4500);
                    protractor_1.browser.wait(EC.presenceOf(page.assetnavinTsg), 25000);
                    _d = (_c = page.IAchildNtree).get;
                    return [4 /*yield*/, page.IAchildNtree.getText()];
                case 2:
                    _d.apply(_c, [(_g.sent()).indexOf('nD Test StationGroup')])
                        .$('[class="arrow-cursor fa fa-caret-right"]').click();
                    protractor_1.browser.sleep(3500);
                    protractor_1.browser.wait(EC.presenceOf(page.assetnavinNts), 25000);
                    _f = (_e = page.IAchildNtree).get;
                    return [4 /*yield*/, page.IAchildNtree.getText()];
                case 3:
                    _f.apply(_e, [(_g.sent()).indexOf('nD Test Station')])
                        .$('[class="arrow-cursor fa fa-caret-right"]').click();
                    protractor_1.browser.sleep(3500);
                    protractor_1.browser.actions().mouseMove(page.assetnavinNts).click().perform();
...
//# sourceMappingURL=spec01_IAsummary.e2e-spec.js.map