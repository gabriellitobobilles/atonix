...
describe('Configure Workflow - Workflow Management', function () {
    ...
    it('should be able to navigate to Issue Snapshot page', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    issueManagemwentPage.openNewIssueBtn.click();
                ...
                case 1:
                    ...
                    expect(issueSnapshotPage.modalHeader.getText()).toMatch('Create New Issue');
                    return [2 /*return*/];
            }
        });
    }); });
    it('should be able to display Issue Category Details', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, user.createNewIssue(issueCreateData)];
                case 1:
    ...
    it('should verify issue created appears in Issue Management Page', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    ...
                    expect(issueManagemwentPage.issueRow.last().$$('td').get(0).getText())
                        .toMatch(issueNumber);
                    return [4 /*yield*/, issueManagemwentPage.getIssueDetailsById(issueTofetch)];
                case 3:
        ...
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    console.log("category: ", issueCreateData.issueCategory);
                    _b = (_a = console).log;
                    _c = ["category Options: "];
                    return [4 /*yield*/, issueSnapshotPage.getCategoryOptions().getText()];
                case 2:
