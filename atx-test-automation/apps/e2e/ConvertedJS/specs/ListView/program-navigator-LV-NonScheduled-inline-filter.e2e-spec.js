...
describe('Non Scheduled Test', function () {
    ...
    describe('In line filter', function () {
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        listview_po_1.listview.createQuickSearch(newQuickSearchColumn);
                        listview_po_1.listview.showColumnOptionsBtn.click();
                        setSelectedColumns(columnsToAdd);
                        _a = lineItemData;
                        _c = (_b = util).getRandomFromArray;
                        return [4 /*yield*/, listview_po_1.listview.getColumnItemsByColName('Asset')];
                    case 1: return [4 /*yield*/, _c.apply(_b, [_d.sent()])];
                    case 2:
                        _a.assetName = _d.sent();
                        // lineItemData.assetName = `Feedwater System`;
                        listview_po_1.listview.editInLineAttribute(lineItemData);
                        listview_po_1.listview.saveListFn(true);
                        return [2 /*return*/];
                }
            });
        }); });
            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, listview_po_1.listview.badgeCtr.getText()];
                    case 2:
                        badgeCtrBefore = _e.sent();
                        listview_po_1.listview.setColumnFilterByName('Asset', searchTermFilter);
                        expect(listview_po_1.listview.badgeCtr.getText()).not.toEqual(badgeCtrBefore);
        ...
        it('should not show any result using INCORRECT Asset filter', function () {
            listview_po_1.listview.setColumnFilterByName('Asset', 'thisIsNotAValidAssetxxx');
            expect(listview_po_1.listview.badgeCtr.getText()).not.toEqual(0);
            listview_po_1.listview.clearInLineFilter('Asset');
        });
        it('should be able to filter Asset Type', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _b = (_a = util).getRandomFromArray;
                        return [4 /*yield*/, listview_po_1.listview.getColumnItemsByColName('Asset Type')];
                    case 1:
                        searchTermFilter = _b.apply(_a, [_e.sent()]);
                        return [4 /*yield*/, listview_po_1.listview.badgeCtr.getText()];
                    case 2:
                        badgeCtrBefore = _e.sent();
                        listview_po_1.listview.setColumnFilterByName('Asset Type', searchTermFilter);
                        expect(listview_po_1.listview.badgeCtr.getText()).not.toEqual(badgeCtrBefore);
                        _d = (_c = util).getRandomFromArray;
                        return [4 /*yield*/, listview_po_1.listview.getColumnItemsByColName('Asset Type')];
                    case 3:
                        newListItems = _d.apply(_c, [_e.sent()]);
                        expect(newListItems).toContain(searchTermFilter);
                        listview_po_1.listview.clearInLineFilter('Asset Type');
                        return [2 /*return*/];
                }
            });
        }); });
        lineItemData.attributes.forEach(function (attr) {
            var dataTypes = listview_po_1.listview.dataTypes;
            ...
            if (attr.dataType !== dataTypes.tag && attr.dataType !== dataTypes.list) {
                it("should be able to filter " + attr.dataType.toUpperCase() + " ", function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    ...
                    return tslib_1.__generator(this, function (_a) {
                        ...
                        listview_po_1.listview.setColumnFilterByName(attribute.name, "" + value);
                        if (attr.dataType === dataTypes.boolean) {
                            listview_po_1.listview.getRowBoolean(lineItemData.assetName).then(function (bol) {
                                expect(bol).toEqual(attr.value.toString());
                            });
                            // expect(listview.getRowBoolean(lineItemData.assetName)).toEqual(attr.value.toString());
                        }
                        else {
                            expect(listview_po_1.listview.getColumnItemsByColName(attribute.name)).toContain(value);
                        }
                        listview_po_1.listview.clearInLineFilter(attribute.name);
                        return [2 /*return*/];
                    });
                }); });
            }
        ...
        lineItemData.attributes.forEach(function (attr) {
            ...
            if (attr.dataType !== dataTypes.tag && attr.dataType !== dataTypes.list
                ...
                it("should be able to PARTIAL filter " + attr.dataType.toUpperCase() + " ", function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    ...
                    return tslib_1.__generator(this, function (_a) {
                        attribute = lineItemData.attributes.filter(function (p) { return p.dataType === attr.dataType; })[0];
                        listview_po_1.listview.setColumnFilterByName(attribute.name, "" + partialValueToFilter_1);
                        if (attr.dataType === dataTypes.boolean) {
                            expect(listview_po_1.listview.getRowBoolean(lineItemData.assetName)).toEqual(attr.value.toString());
                        }
                        else {
                            expect(listview_po_1.listview.getColumnItemsByColName(attribute.name)).toContain(value);
                        }
        ...
        xit('should be able to Save list with In-line filter', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, listview_po_1.listview.getColumnItemsByColName('Asset')];
                    case 1:
                        listItems = _a.sent();
                        listview_po_1.listview.saveQuickSearchFn(newQuickSearchColumn, true);
                        expect(listview_po_1.listview.getColumnItemsByColName('Asset')).toEqual(listItems);
                        return [2 /*return*/];
                }
            });
        }); });
...
function setSelectedColumns(columnToAdd) {
    listview_po_1.listview.setSelectedColumns(columnToAdd);
    listview_po_1.listview.okBtnColumnDialog.click();
    listview_po_1.listview.waitForSpinner();
}
function generateLineItemData() {
    return {
        assetName: '',
        attributes: [
            { name: 'Tags', dataType: listview_po_1.listview.dataTypes.tag, value: [casual.word + "Tag", casual.word + "Tag"] },
            { name: 'testAutoString', dataType: listview_po_1.listview.dataTypes.string, value: casual.word + "String" },
            { name: 'testAutoFloat', dataType: listview_po_1.listview.dataTypes.float, value: "" + casual.double(1, 2000) },
            { name: 'testAutoInt', dataType: listview_po_1.listview.dataTypes.int, value: "" + casual.integer(1, 1000) },
            { name: 'testAutoList', dataType: listview_po_1.listview.dataTypes.list, value: "List3" },
            { name: 'testAutoBoolean', dataType: listview_po_1.listview.dataTypes.boolean, value: true },
            {
                name: 'testAutoDate', dataType: listview_po_1.listview.dataTypes.date,
...
//# sourceMappingURL=program-navigator-LV-NonScheduled-inline-filter.e2e-spec.js.map