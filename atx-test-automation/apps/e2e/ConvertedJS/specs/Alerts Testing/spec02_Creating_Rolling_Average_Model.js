...
describe('Alerts: Creating Rolling Average models', function () {
    ...
    it('Creating Rolling Average Model', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_6) {
            switch (_6.label) {
                ...
                case 16: 
                // tslint:disable-next-line:max-line-length
                return [4 /*yield*/, _p.apply(_o, [(_6.sent()).indexOf('Mill D')])
                        .$('[class="arrow-cursor fa fa-caret-right"]').click()];
                case 17:
                    // tslint:disable-next-line:max-line-length
                    _6.sent();
                ...
                case 20:
                    ...
                    appTitle.selectDropdownbyNum(protractor_1.$('[ng-model="vm.selectedModelType"]'), 1);
                ...
                case 25:
                    ...
                    return [4 /*yield*/, appTitle.dataExplorerNavElemSelector.assetNodeTree
                            .getText()];
                case 26: return [4 /*yield*/, _r.apply(_q, [(_6.sent()).indexOf('nD Test Client')])
                        .$('[class="arrow-cursor fa fa-caret-right"]').click()];
                case 27:
                    _6.sent();
                ...
                case 38: 
                // tslint:disable-next-line:max-line-length
                return [4 /*yield*/, _3.apply(_2, [(_6.sent()).indexOf('Mill D')])
                        .click()];
                case 39:
                    // tslint:disable-next-line:max-line-length
                    _6.sent();
                ...
                case 41:
                    ...
                    return [4 /*yield*/, protractor_1.$$('[class="text-right lightTableCell ng-binding"]')
                            .getText()];
                case 42: return [4 /*yield*/, _5.apply(_4, [(_6.sent()).indexOf(modelName) + 7]).getText()];
                case 43:
                    divs2 = _6.sent();
                    console.log(divs);
                    console.log(divs2);
    ...
    it('Deleting Rolling Average model', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
...
//# sourceMappingURL=spec02_Creating_Rolling_Average_Model.js.map