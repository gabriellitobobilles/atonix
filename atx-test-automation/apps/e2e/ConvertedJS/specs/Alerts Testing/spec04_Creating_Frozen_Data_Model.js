...
describe('Alerts: Creating Frozen Data models', function () {
    ...
    it('Creating Frozen Data Model', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_6) {
            switch (_6.label) {
                ...
                case 16: 
                // tslint:disable-next-line:max-line-length
                return [4 /*yield*/, _p.apply(_o, [(_6.sent()).indexOf('Mill A')])
                        .$('[class="arrow-cursor fa fa-caret-right"]').click()];
                case 17:
                    // tslint:disable-next-line:max-line-length
                    _6.sent();
                ...
                case 39: 
                // tslint:disable-next-line:max-line-length
                return [4 /*yield*/, _3.apply(_2, [(_6.sent()).indexOf('Mill A')])
                        .click()];
                case 40:
                    // tslint:disable-next-line:max-line-length
                    _6.sent();
                ...
                case 42:
                    ...
                    return [4 /*yield*/, protractor_1.$$('[class="text-right lightTableCell ng-binding"]')
                            .getText()];
                case 43: return [4 /*yield*/, _5.apply(_4, [(_6.sent()).indexOf(modelName) + 7]).getText()];
                case 44:
                    divs2 = _6.sent();
                    console.log(divs);
                    console.log(divs2);
    ...
    it('Deleting Frozen Data model', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
...
//# sourceMappingURL=spec04_Creating_Frozen_Data_Model.js.map