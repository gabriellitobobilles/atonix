...
describe('Configure Workflow - Resolution Status', function () {
    beforeAll(function () {
    ...
    it('Verify Action Type drop down list & ensure user is able to select', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            ...
            workflowEditorPage.selectActionTypeFn(actionTypes.updateAttribute);
            ...
            workflowEditorPage.selectActionTypeFn(actionTypes.updateResolutionStatus);
            expect(workflowEditorPage.actionAttributeFormObj.actionNameTxt.isPresent()).toBeTruthy();
            expect(workflowEditorPage.targetResolutionStatusDropdown.isPresent()).toBeTruthy();
            workflowEditorPage.deleteActionBtn.click(); // delete action for next step
            return [2 /*return*/];
        });
    }); });
