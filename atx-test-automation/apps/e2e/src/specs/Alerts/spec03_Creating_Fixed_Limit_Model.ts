...
describe('Alerts: Creating Fixed Limit models', () => {
  ...
  it('Creating Fixed Limit Model', async () => {
    ...
    // tslint:disable-next-line:max-line-length
    await appTitle.dataExplorerNavElemSelector.assetChildNodeTree.get((await appTitle.dataExplorerNavElemSelector.assetChildNodeTree.getText()).indexOf('Mill C'))
      .$('[class="arrow-cursor fa fa-caret-right"]').click();
    ...
    appTitle.selectDropdownbyNum($('[ng-model="vm.selectedModelType"]'), 2);
    ...
    // tslint:disable-next-line:max-line-length
    $('[ng-click="$ctrl.localChange(\'ActiveConfiguration\', \'Anomalies\'); $ctrl.localChange(\'ShowHide Range Selector\', false)"]').click();
    await $('[ng-model="$ctrl.anomaliesConfig.ActivateFixedUpper"]').click();
    $('[ng-model="$ctrl.anomaliesConfig.FixedLimitUpper"]').click();
    $('[ng-model="$ctrl.anomaliesConfig.FixedLimitUpper"]').sendKeys('50000');
    await $('[ng-model="$ctrl.anomaliesConfig.ActivateFixedLower"]').click();
    $('[ng-model="$ctrl.anomaliesConfig.FixedLimitLower"]').click();
    $('[ng-model="$ctrl.anomaliesConfig.FixedLimitLower"]').sendKeys('30000');
    browser.sleep(3000);
    ...
    // tslint:disable-next-line:max-line-length
    await appTitle.dataExplorerNavElemSelector.assetTree.get((await appTitle.dataExplorerNavElemSelector.assetTree.getText()).indexOf('Mill C'))
      .click();
  ...
  it('Deleting Fixed Limit model', async () => {
