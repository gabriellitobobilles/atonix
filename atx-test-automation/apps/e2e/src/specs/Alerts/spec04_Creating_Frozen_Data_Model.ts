...
describe('Alerts: Creating Frozen Data models', () => {
  ...
  it('Creating Frozen Data Model', async () => {
    ...
    // tslint:disable-next-line:max-line-length
    await appTitle.dataExplorerNavElemSelector.assetChildNodeTree.get((await appTitle.dataExplorerNavElemSelector.assetChildNodeTree.getText()).indexOf('Mill A'))
      .$('[class="arrow-cursor fa fa-caret-right"]').click();
    ...
    // tslint:disable-next-line:max-line-length
    $('[ng-click="$ctrl.localChange(\'ActiveConfiguration\', \'Alerts\'); $ctrl.localChange(\'ShowHide Range Selector\', false)"]').click();
    await $$('[ng-model="$ctrl.alertsConfig.ActivateFrozen"]').first().click();
    $$('[ng-model="$ctrl.alertsConfig.FrozenDataDuration"]').first().click();
    $$('[ng-model="$ctrl.alertsConfig.FrozenDataDuration"]').first().sendKeys('30000');
    appTitle.selectDropdownbyNum($$('[ng-model="$ctrl.alertsConfig.FrozenDataDurationTemporalTypeID"]').first(), 3);
    browser.sleep(3000);
    ...
    // tslint:disable-next-line:max-line-length
    await appTitle.dataExplorerNavElemSelector.assetTree.get((await appTitle.dataExplorerNavElemSelector.assetTree.getText()).indexOf('Mill A'))
      .click();
  ...
  it('Deleting Frozen Data model', async () => {
