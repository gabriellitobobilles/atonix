...
describe('Service: WorkflowService', () => {
  ...
  it('should return asset Tree', inject(
    [WorkflowService, HttpTestingController],
    (workflowService: WorkflowService, httpTest: HttpTestingController) => {
      let result;
      workflowService.populateAssetTree().subscribe((data: any) => {
        result = data;
      });
